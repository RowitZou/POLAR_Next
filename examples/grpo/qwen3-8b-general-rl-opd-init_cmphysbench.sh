...
policy_model_name=Qwen3-8B-General-RL-opd-init
reward_model_name=SEED

# Model paths
actor_path=/mnt/shared-storage-user/ailab-hs/zouyicheng/POLAR_Next/outputs/verl_opd_policy_Qwen3-8B_General_GRPO_reward_ZERO_ref_Qwen3-30B-A3B_data_cmphysbench_lr_1e-6/hf_models/actor_global_step_440
...
reward_func_path="../src/rule/reward_seed_remote.py"
...
if [ "$RANK" -eq 0 ]; then 
    ...
    trainer.project_name='verl_grpo_cmphysbench' \
