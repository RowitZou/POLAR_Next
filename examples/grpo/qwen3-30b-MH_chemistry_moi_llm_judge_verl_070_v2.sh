...
# actor_path=/mnt/shared-storage-user/ailab-hs/zouyicheng/POLAR_Next/outputs/verl_grpo_policy_Qwen3-30B-A3B-MH_reward_RULE_LLM_JUDGE_data_chemistry_moi/hf_models/actor_global_step_240
...
reward_manager_path="../src/reward/mix_env/chemistry_reward_manager_v2.py"
