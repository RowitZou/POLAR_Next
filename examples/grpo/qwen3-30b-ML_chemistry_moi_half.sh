...
policy_model_name=Qwen3-30B-A3B-ML
reward_model_name=RULE

# Model paths
actor_path=/mnt/shared-storage-user/ailab-hs/zouyicheng/POLAR/outputs/sft/Qwen3_30B_A3_instruct-general-continue-mix-remove-cot-half-part1/20260211062654/hf-latest
