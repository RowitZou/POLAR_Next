...
policy_model_name=Qwen3-8B-General-RL
reward_model_name=SEED

# Model paths
actor_path=/mnt/shared-storage-user/ailab-hs/zouyicheng/POLAR/outputs/verl_ppo_policy_Qwen3-8B-Instruct_reward_POLAR-7B_data_General/actor_global_step_1100
