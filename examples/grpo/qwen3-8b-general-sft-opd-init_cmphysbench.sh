...
policy_model_name=Qwen3-8B-General-SFT-opd-init
reward_model_name=SEED

# Model paths
actor_path=/mnt/shared-storage-user/ailab-hs/zouyicheng/POLAR_Next/outputs/verl_opd_policy_Qwen3-8B_General_SFT_reward_ZERO_ref_Qwen3-30B-A3B_data_cmphysbench_lr_1e-6/hf_models/actor_global_step_190
