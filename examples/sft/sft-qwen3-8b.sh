...
# Model paths
model_path=/mnt/shared-storage-user/ailab-hs/chenjiayi/models/opensource/Qwen3-8B

# Data paths
train_data_path=/mnt/shared-storage-user/ailab-hs/chenjiayi/data/OpenThoughts3-1.2M/process_data/train_400k.parquet
test_data_path=/mnt/shared-storage-user/ailab-hs/chenjiayi/data/OpenThoughts3-1.2M/process_data/train_400k.parquet # nouse
